						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="{{ url("#man") }}" role="tab">Man</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="{{ url("#women") }}" role="tab">Woman</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="{{ url("#kids") }}" role="tab">Kids</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="{{ url("#accessories") }}" role="tab">Accessories</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="{{ url("#essential") }}" role="tab">Essential</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="{{ url("#prices") }}" role="tab">Prices</a></li>
								</ul>
								<!--/ End Tab Nav -->
							</div>
										...
										<div class="row">
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="{{ url("product-details.html") }}">Women Pant Collectons</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="{{ url("product-details.html") }}">Awesome Cap For Women</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="{{ url("product-details.html") }}">Polo Dress For Women</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
